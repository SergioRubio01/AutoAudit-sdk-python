...
class AutoauditInterfacesApiV1SuperagentsCreateAgentRequest(BaseModel):
    """
    ...
    execution_tier: Optional[StrictStr] = 'standard'
    max_iterations: Optional[StrictInt] = 10
    __properties: ClassVar[List[str]] = ["name", "description", "capabilities", "tools", "llm_id", "metadata", "execution_tier", "max_iterations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "execution_tier": obj.get("execution_tier") if obj.get("execution_tier") is not None else 'standard',
