...
class AgentListResponse(BaseModel):
    ...
    """ # noqa: E501
    agents: List[AutoauditInterfacesApiV1SuperagentsAgentResponse]
    total: StrictInt
    page: StrictInt
    page_size: StrictInt
    __properties: ClassVar[List[str]] = ["agents", "total", "page", "page_size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agents": [AutoauditInterfacesApiV1SuperagentsAgentResponse.from_dict(_item) for _item in obj["agents"]] if obj.get("agents") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
